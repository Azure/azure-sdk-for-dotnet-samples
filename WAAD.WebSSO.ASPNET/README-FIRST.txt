...
In order to use the PowerShell cmdlets provided under the %ROOT%/csharp/scripts/ directory, you will need to build the DLL that provides the WAAD functionality. 
...
This will build the DLL and copy the DLL to the correct location under %ROOT%/csharp/scripts/
